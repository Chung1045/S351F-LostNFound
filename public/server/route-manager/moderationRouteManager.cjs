...
const { createReport, getReports, updateReportStatus, deleteUser, deleteComment } = require('../controllers/moderationController.cjs');
...
router.delete('/admin/comments/:id', authMiddleware, isAdmin, deleteComment);
